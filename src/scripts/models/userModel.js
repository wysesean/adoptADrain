...
UserAuthModel.getCurrentUser = function() {
	return JSON.parse(localStorage.getItem('adoptADrain'+ '_user')) ? new User(JSON.parse(localStorage.getItem('adoptADrain' + '_user'))) : null
}
...
const User = UserAuthModel.extend({
	...
	updateCurrentUser: function() {
		localStorage.setItem('adoptADrain_user', JSON.stringify(this.attributes))
	}
})
